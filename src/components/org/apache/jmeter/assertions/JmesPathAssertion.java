	...
	private boolean checkResult(String result) {
		...
		if (isResultEmpty && isExpectNull() && !isInvert()) {
			...
			// ======================= CHECK INVERT ================================
			    ...
			    return setBooleanResult(false, String.format(RESULT_VALUE_EQUALS_INVERT_SUCCESS, expectedValue, result));

			} else if (!result.equals(expectedValue) && isInvert()) {
			    return setBooleanResult(true, String.format(RESULT_VALUE_DIFFERENT_INVERT_SUCCESS, result, expectedValue));
