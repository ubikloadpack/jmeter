...
public class JSONPathAssertionGui extends AbstractAssertionGui implements ChangeListener {
    ...
    protected JLabeledTextField jsonPath =  new JLabeledTextField(JMeterUtils.getResString(JSON_ASSERTION_PATH));
    protected JLabeledTextArea jsonValue = new JLabeledTextArea(JMeterUtils.getResString(JSON_ASSERTION_EXPECTED_VALUE));
    protected JCheckBox jsonValidation = new JCheckBox(JMeterUtils.getResString(JSON_ASSERTION_VALIDATION));
    protected JCheckBox expectNull = new JCheckBox(JMeterUtils.getResString(JSON_ASSERTION_NULL));
    protected JCheckBox invert = new JCheckBox(JMeterUtils.getResString(JSON_ASSERTION_INVERT));
    protected JCheckBox isRegex = new JCheckBox(JMeterUtils.getResString(JSON_ASSERTION_REGEX));
